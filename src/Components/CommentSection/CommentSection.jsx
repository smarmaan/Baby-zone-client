  ...
  return (
    <div className="my-20">
      <div
        ...
        className="card md:w-[50%] mx-auto bg-[#fbffdc] text-[#0a4d7b] font-Cambria my-16"
      >
 ...
 */}
            <div className=" card w-96 mx-7  bg-base-100 shadow-xl">
              ...
              <div className="card-body">
                ...
                <p>
                  I can not get enough of the action figures from this store!
                  They make playtime so much more exciting.
                </p>
              </div>
            </div>
            {/* 
 ...
 */}
            ...
            <div className=" card w-96 mx-7  bg-base-100 shadow-xl">
              ...
              <div className="card-body">
                ...
                <p>
                  As a collector, I am thrilled with the rare and
                  limited-edition action figures I found here. My collection is
                  now complete!
                </p>
              </div>
            </div>
